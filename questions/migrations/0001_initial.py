# Generated by Django 2.1.7 on 2019-05-25 17:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(db_index=True, max_length=64, unique=True)),
            ],
        ),
        migrations.AddField(
            model_name='question',
        ...
        migrations.AlterUniqueTogether(
            name='likedislike',
            unique_together={('content_type', 'object_id', 'vote', 'user')},
        ),
